...
-- Set defaults
vim.o.tabstop = 4 -- width of a hard tab
vim.o.shiftwidth = 4 -- width for auto-indent
...
vim.keymap.set("n", "<leader>h", "<cmd>LspClangdSwitchSourceHeader<CR>", { desc = "Switch source / header" })
